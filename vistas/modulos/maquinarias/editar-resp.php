...
<div class="content-wrapper">
	...
	<section class="content-header">
	    ...
	    <ol class="breadcrumb">
	      ...
	      <li class="active">Editar maquinaria</li>
			...
			<div class="col-md-12">
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Editar maquinaria</h3>
					</div>
					<div class="box-body">
						...
						<form id="formSend" method="POST" action="<?php echo Route::names('maquinarias.update', $maquinaria->id); ?>" enctype="multipart/form-data">
							...
							<input type="button" id="btnSend" class="btn btn-primary" value="Actualizar maquinaria">
							<div id="msgSend"></div>
						</form>
					</div>
				</div>
