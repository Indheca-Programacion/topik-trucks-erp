...
$ordenCompra = mb_strtoupper(fString($inventarioSalida->ordenCompra));
$recibe = mb_strtoupper($inventarioSalida->usuarioRecibe);
$autorizo = mb_strtoupper($inventarioSalida->usuarioAutorizo);
...
$pdf->Image($entregoFirma, 10, 230, 50, 0, $extension, '', '', false, 300, '', false, false, 0, 'CT', false, false);
...
if ( $extension == 'PNG')  $pdf->setJPEGQuality(75); // Calidad de imágen
$pdf->Image($firmaAutorizo, 135, 230, 70, 0, $extension, '', '', false, 300, '', false, false, 0, 'CT', false, false);
