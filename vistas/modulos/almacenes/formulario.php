<?php
	if ( isset($almacen->id) ) {
		$descripcion = isset($old["descripcion"]) ? $old["descripcion"] : $almacen->descripcion;
...
<div class="form-group">
	...
	<input type="text" id="descripcion" name="descripcion" value="<?php echo fString($descripcion); ?>" class="form-control form-control-sm text-uppercase" placeholder="Ingresa la descripción del almacén">
</div>
