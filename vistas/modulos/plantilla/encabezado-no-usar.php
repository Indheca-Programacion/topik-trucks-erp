...
<head>
  ...
  <title><?php echo CONST_APP_NAME; ?> | Inicio</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo Route::rutaServidor(); ?>vistas/adminlte/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
...
<!-- <script src="<?php echo Route::rutaServidor(); ?>vistas/adminlte/dist/js/demo.js"></script> -->
</body>
</html>
