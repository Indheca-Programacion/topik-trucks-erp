...
$entrego = mb_strtoupper($inventario->entrego);
...
$pdf->MultiCell(30, 5, "{$inventario->fechaEntrega}", 'B', '', 0, 1, '', '', true);
...
$pdf->Image($inventario->firma, 10, 250, 50, 0, $extension, '', '', false, 300, '', false, false, 0, 'CT', false, false);

$extension = mb_strtoupper(substr($recibioFirma, -3, 3));
if ( $extension == 'PNG')  $pdf->setJPEGQuality(75); // Calidad de imágen
$pdf->Image($recibioFirma, 75, 250, 70, 0, $extension, '', '', false, 300, '', false, false, 0, 'CT', false, false);
