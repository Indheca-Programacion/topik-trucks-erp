...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<div class="container-fluid">
	      <div class="row mb-2">
	        <div class="col-sm-6">
	          <h1>Servicios <small class="font-weight-light">Editar</small></h1>
	        </div>
	        <div class="col-sm-6">
	          <ol class="breadcrumb float-sm-right">
	            <li class="breadcrumb-item"><a href="<?=Route::routes('inicio')?>"> <i class="fas fa-tachometer-alt"></i> Inicio</a></li>
	            <li class="breadcrumb-item"><a href="<?=Route::names('servicios.index')?>"> <i class="fas fa-tools"></i> Servicios</a></li>
			...
			<div class="col-md-12">
				<div class="card card-primary card-outline">
					...
					<div class="card-body">
						...
						<?php include "vistas/modulos/servicios/formulario.php"; ?>
		...
		<div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="modalVerImagenesLabel">Evidencia Fotográfica <span></span></h5>
