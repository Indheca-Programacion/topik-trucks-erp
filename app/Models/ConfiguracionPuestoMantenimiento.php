...
if ( file_exists ( "app/Policies/ConfiguracionPuestoMantenimientoPolicy.php" ) ) {
    require_once "app/Policies/ConfiguracionPuestoMantenimientoPolicy.php";
} else {
    require_once "../Policies/ConfiguracionPuestoMantenimientoPolicy.php";
}

use App\Conexion;
use PDO;
use App\Policies\ConfiguracionPuestoMantenimientoPolicy;

class ConfiguracionPuestoMantenimiento extends ConfiguracionPuestoMantenimientoPolicy
{
    static protected $fillable = [
        'id_puesto', 'id_tipo_mantenimiento','id'
    ];
    ...
    protected $tableName = "puesto_tipo_mantenimiento";
    ...
    /*=============================================
    MOSTRAR PUESTOS Y TIPO DE MANTENIMIENTO
    =============================================*/
    public function consultar()
    {
        $respuesta = Conexion::queryAll($this->bdName, "SELECT PTU.id as id_puesto_tipo_mantenimiento, PTU.id_puesto, PTU.id_tipo_mantenimiento, P.nombre AS nombre_puesto, MT.descripcion AS nombre_tipo_mantenimiento FROM puesto_tipo_mantenimiento PTU
        INNER JOIN puesto P ON PTU.id_puesto = P.id
        INNER JOIN mantenimiento_tipos MT ON PTU.id_tipo_mantenimiento = MT.id", $error);


        $puestos_limpios = [];
        foreach ($respuesta as $fila) {
            $puestos_limpios[] = [
                "id_puesto_tipo_mantenimiento" => $fila["id_puesto_tipo_mantenimiento"],
                "nombre_tipo_mantenimiento" => $fila["nombre_tipo_mantenimiento"],
                "nombre_puesto" => $fila["nombre_puesto"]
            ];
        }
