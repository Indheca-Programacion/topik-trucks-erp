...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<div class="container-fluid">
		  <div class="row mb-2">
			<div class="col-sm-6">
			  <h1>Checklist Maquinarias <small class="font-weight-light">Crear</small></h1>
			</div>
			<div class="col-sm-6">
			  <ol class="breadcrumb float-sm-right">
				...
				<li class="breadcrumb-item active">Crear checklist</li>
			  </ol>
			</div>
		  </div>
		</div><!-- /.container-fluid -->
			...
			<div class="col-md-6">
				<div class="card card-primary card-outline">
					...
					<div class="card-body">
						...
						<form id="formSend" method="POST" action="<?php echo Route::names('checklist-maquinarias.store'); ?>">
