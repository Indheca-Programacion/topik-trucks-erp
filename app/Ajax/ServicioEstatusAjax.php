...
class ServicioEstatusAjax
{
    ...
    public function mostrarTabla()
    {
        ...
        foreach ($servicioStatus as $key => $value) {
            $rutaEdit = Route::names('servicio-estatus.edit', $value['id']);
            $rutaDestroy = Route::names('servicio-estatus.destroy', $value['id']);
...
$servicioEstatusAjax = New ServicioEstatusAjax;
...
if ( isset($_POST["nombreServicioEstatus"]) ) {
    ...
    AGREGAR SERVICIO ESTATUS
    =============================================*/ 
    $servicioEstatusAjax->token = $_POST["_token"];
    $servicioEstatusAjax->descripcion = $_POST["nombreServicioEstatus"];
    $servicioEstatusAjax->agregar();
    ...
    TABLA DE SERVICIO ESTATUS
    =============================================*/
    $servicioEstatusAjax->mostrarTabla();
