...
class PagosController
{
    ...
    {
        // Autorizacion::authorize('view', new Pago);
        require_once "app/Models/Requisicion.php";
        $requisicion = new \App\Models\Requisicion;
        $requisiciones = $requisicion->consultarPendientePago();

        require_once "app/Models/OrdenCompra.php";
        $ordenCompra = new \App\Models\OrdenCompra;
        $ordenes = $ordenCompra->consultarPendientePago();

        $contenido = array('modulo' => 'vistas/modulos/pagos/index.php');
