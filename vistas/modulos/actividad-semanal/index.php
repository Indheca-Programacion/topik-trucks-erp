...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Actividad Semanal <small class="font-weight-light">Listado</small></h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?=Route::routes('inicio')?>"> <i class="fas fa-tachometer-alt"></i> Inicio</a></li>
            <li class="breadcrumb-item active">Actividad Semanal</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
          ...
          <div class="card card-secondary card-outline">
            <div class="card-header">
              <h3 class="card-title">
                ...
                Listado de Actividad Semanal
              </h3>
              <div class="card-tools">
                <a href="<?=Route::names('actividad-semanal.create')?>" class="btn btn-outline-primary ml-1 float-right">
                  <i class="fas fa-plus"></i> Crear actividad semanal
                </a>    
            ...
            <div class="card-body">
              ...
              <table class="table table-sm table-bordered table-striped" id="tablaActividadSemanal" width="100%">
