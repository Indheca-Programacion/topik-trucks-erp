...
<div class="row">
	...
	<div class="col-md-6 form-group">
		...
		<input type="text" id="folio" value="<?= $folio ;?>" class="form-control form-control-sm text-uppercase" <?php if(isset($generador->id))echo 'readonly' ?>>
	</div>
	<?php endif ?>
	<!-- Obra -->
	<div class="col-md-6 form-group">
		...
		<!-- <input type="text" id="obra" name="obra" value="<?= $obra ;?>" class="form-control form-control-sm text-uppercase" <?php if(isset($generador->id))echo 'readonly' ?>> -->
		<select name="obraId" id="obraId" class="custom-select form-controls select2"  <?php if(isset($generador->id)) echo 'disabled' ?>>
    ...
    <div class="col-md-6 form-group">
        ...
        <select id="ubicacionId" name="ubicacionId" class="custom-select form-controls select2"  <?php if(isset($generador->id))echo ' disabled' ?>>
    ...
    <div class="col-md-6 form-group">
        ...
        <input type="month" name="mes" id="mes" value="<?= $mes ; ?>" class="form-control form-control-sm"  <?php if(isset($generador->id))echo 'readonly' ?>>
    
	</div>
	<!-- Empresa -->
	<div class="col-md-6 form-group">
		<label for="empresaId">Empresa:</label>
		<select name="empresaId" id="empresaId" class="custom-select form-controls select2"  <?php if(isset($generador->id)) echo 'disabled' ?>>
	...
	<?php if (!isset($generador->id)) : ?>
	<div class="col-md-6 form-group">
		<label for="generadorId">Copiar Generador:</label>
		<select name="generadorId" id="generadorId" class="custom-select form-controls select2">
