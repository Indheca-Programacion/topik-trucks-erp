...
require_once "app/Models/RequisicionTraslado.php";
...
class RequisicionTrasladosController
{
    ...
    public function create($id)
    {
        ...
        if ( $servicio->consultar(null , $traslado->servicio) ) {
            ...
            $contenido = array('modulo' => 'vistas/modulos/requisicion-traslados/crear.php');
    ...
    {    
        ...
        if ( !isset($request['comprobanteArchivos']) && !isset($request['detalles']) ) {
            ...
            $trasladoId = $request['trasladoId'];
            header("Location:" . Route::routes('traslados.crear-requisicion', $trasladoId));
    ...
    public function edit($id)
    {
        ...
        if ( $requisicion->consultar(null , $id) ) {
            ...
            require_once "app/Models/Traslado.php";
            $traslado = New Traslado;
            if( $traslado->consultar(null, $requisicion->trasladoId) ) {
