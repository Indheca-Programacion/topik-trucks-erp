$(function(){
	...
	let tableList = document.getElementById('tablaEstatusOrdenCompra');

	// LLamar a la funcion fAjaxDataTable() para llenar el Listado
	if ( tableList != null ) fAjaxDataTable(rutaAjax+'app/Ajax/EstatusOrdenCompraAjax.php', '#tablaEstatusOrdenCompra');
