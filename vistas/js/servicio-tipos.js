$(function(){
	...
	let tableList = document.getElementById('tablaServicioTipos');

	// LLamar a la funcion fAjaxDataTable() para llenar el Listado
	if ( tableList != null ) fAjaxDataTable(rutaAjax+'app/Ajax/ServicioTipoAjax.php', '#tablaServicioTipos');

	// Confirmar la eliminación del Tipo de Servicio
	$(tableList).on("click", "button.eliminar", function (e) {
	    ...
	    Swal.fire({
			title: '¿Estás Seguro de querer eliminar este Tipo de Servicio (Descripción: '+folio+') ?',
