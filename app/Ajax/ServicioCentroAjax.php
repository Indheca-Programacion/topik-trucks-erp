...
class ServicioCentroAjax
{

    /*=============================================
    TABLA DE CENTROS DE SERVICIO
    =============================================*/
    public function mostrarTabla()
    {
        ...
        foreach ($servicioCentros as $key => $value) {
            $rutaEdit = Route::names('servicio-centros.edit', $value['id']);
            $rutaDestroy = Route::names('servicio-centros.destroy', $value['id']);
    ...
    public function agregar(){
        ...
        if ( usuarioAutenticado() ) {
            ...
            if ( !Autorizacion::perfil($usuario, CONST_ADMIN) && !Autorizacion::permiso($usuario, "servicio-centros", "crear") ) {

                $respuesta["error"] = true;
                $respuesta["errorMessage"] = "No está autorizado a crear nuevos Centros de Servicio.";
        ...
        if ( $servicioCentro->consultar("descripcion", $this->descripcion) ) {
            ...
            if ( $servicioCentro->crear($datos) ) {

                $respuesta["respuestaMessage"] = "El centro de servicio fue creado correctamente.";

                // Si lo pudo crear, consultar el registro para obtener el Id en el Ajax
                $respuesta["respuesta"] = $servicioCentro->consultar("descripcion", $this->descripcion);
...
$servicioCentroAjax = New ServicioCentroAjax;

if ( isset($_POST["nombreServicioCentro"]) ) {

    /*=============================================
    AGREGAR CENTRO DE SERVICIO
    =============================================*/ 
    $servicioCentroAjax->token = $_POST["_token"];
    $servicioCentroAjax->descripcion = $_POST["nombreServicioCentro"];
    $servicioCentroAjax->agregar();
    ...
    TABLA DE CENTROS DE SERVICIO
    =============================================*/
    $servicioCentroAjax->mostrarTabla();
