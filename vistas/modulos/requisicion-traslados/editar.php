	      ...
	      <div class="row mb-2">
	        ...
	        <div class="col-sm-6">
	          <ol class="breadcrumb float-sm-right">
	            ...
	            <li class="breadcrumb-item"><a href="<?=Route::names('requisicion-traslados.index')?>"> <i class="fas fa-tools"></i> Requisiciones</a></li>
			...
			<div class="col-md-12">
				<div class="card card-primary card-outline">
					...
					<div class="card-body">
						...
						<form id="formSend" method="POST" action="<?php echo Route::names('requisicion-traslados.update', $requisicion->id); ?>" enctype="multipart/form-data">
							<input type="hidden" name="_method" value="PUT">
							<?php include "vistas/modulos/requisicion-traslados/formulario.php"; ?>
							...
							<div class="btn-group descargar-archivos">
								...
								<div class="dropdown-menu">
									...
									<a class="dropdown-item <?php if ( $cantidadComprobantes == 0 ) echo "disabled-link"; ?>" href="#" id="btnDescargarTodo">Descargar Todo</a>
								</div>
							</div>
...
<?php
	array_push($arrayArchivosJS, 'vistas/js/requisicion-traslados.js?v=1.00');
?>
